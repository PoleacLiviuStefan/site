...
const Footer = () => {
  ...
  return (
    <div name="Footer" className='flex lg:justify-center relative bg-[#ebdae0] w-full h-[45rem] lg:h-[20rem]'>
            <div className='relative w-[90%] flex  justify-center h-full ' >
                <div className='w-[80%] mt-[4rem] flex flex-col items-center justify-between lg:h-full h-[80%] lg:grid lg:grid-cols-3'>
                ...
                <h3 className='absolute bottom-0 ml-[1rem] lg:ml-0 text-[14px]' > @ 2023 CURSURI UNGHII IN BUCURESTI  ADINA HIRSCH</h3>
            </div>
