...
const Galerie = () => {
    ...
    const imageSelection=['bg-unghii','bg-unghii2','bg-unghii3','bg-unghii4','bg-unghii5','bg-unghii6','bg-unghii7','bg-unghii8','bg-unghii9','bg-unghii10','bg-unghii11','bg-unghii12','bg-unghii13','bg-unghii14','bg-unghii15',]
  return (
